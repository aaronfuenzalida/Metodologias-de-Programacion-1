...
using Metodologias_de_Programacion.Clase_6_Composite__TemplateMethod.Iterator;

namespace Metodologias_de_Programacion.Clase_6_Composite__TemplateMethod.Collections
{
	/// <summary>
